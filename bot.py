    ...
    try:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ydl_opts = {
                ...
                # מעדיף MP4, מגביל ל-50MB (הגבלת טלגרם לבוטים)
                "format": "(bestvideo[ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]/best)[filesize<50M]",
        ...
        await status_msg.edit_text(
            "❌ לא הצלחתי להוריד את הסרטון.\n"
            "ייתכן שהסרטון פרטי, נמחק, או שהקישור לא תקין."
        )
